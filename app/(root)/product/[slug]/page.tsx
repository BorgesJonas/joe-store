...
import { Price } from "@/components/shared/product/product-card/components/price";
import { ProductsImages } from "@/components/shared/product/product-images";
            ...
            <CardContent className="p-4">
              ...
              {product.stock > 0 && (
                <div className="flex-center">
                  <AddToCartButton item={addToCartItem} cart={cart} />
                </div>
              )}
            </CardContent>
          </Card>
